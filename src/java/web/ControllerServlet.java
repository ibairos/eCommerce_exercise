...
public class ControllerServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        actionMap.put("/viewcart.do", new viewcartAction((CategoryModel) context.getAttribute("categoryModel"),(ProductModel) context.getAttribute("productModel")));
        actionMap.put("/updatecart.do", new updatecartAction());
